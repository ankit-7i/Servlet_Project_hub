...
<head>
    ...
    <title>Update Successful - ElectroStore Admin</title>
...
<body>
    <div class="confirmation-container">
        ...
        <div class="confirmation-body">
            ...
            <div class="update-details">
                <div class="details-title">Recent Update</div>
                <div class="details-item">
                    <div class="details-label">Updated By:</div>
                ...
                <div class="details-item">
                    ...
                    <div class="details-value">Successfully Updated</div>
                </div>
            </div>
    ...
    <script>
        ...
        // Add subtle animation to success icon
